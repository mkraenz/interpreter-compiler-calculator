...
describe("interpret()", () => {
    ...
    it("returns -3 for 4 Shout! 5 Rock! 4 Shout! EVERYBODY_NOW 3 Yeah! 2 JUMP!", () => {
    ...
    it("returns 4.8 for 4 Death! 5 Rock! EVERYBODY_NOW 4 Death! EVERYBODY_NOW 3 Shout! 2 JUMP! JUMP!", () => {
        const input =
